...
abstract class SortAlgorithm {
	...
	/*
	 * Markers to mark the high and low bounds of the sort's progress or the
	 * high and low bounds of its current area of concern.
	 */
	...
	/**
	 * Count the total number of comparisons, movements, and other array
	 * accesses.
	 */
